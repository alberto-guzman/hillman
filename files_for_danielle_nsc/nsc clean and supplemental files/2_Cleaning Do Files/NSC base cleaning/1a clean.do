...
*******************************************************************************
	...
	* COLLEGE ID
	gen CollegeCodeBranch = collegecodebranch
	destring CollegeCodeBranch, ignore(`" -"') force replace
	...
	* COLLEGE TYPE
	...
	label define vCollegeType 1 "2-year" 2 "4-year"
	...
	* PUBLIC OR PRIVATE COLLEGE
	...
	label define vCollegePublic 0 "Private" 1 "Public"
	...
	* CLASS LEVEL
	...
	label define vClassLevel 1 "Freshman" 2 "Sophomore" 3 "Junior" 4 "Senior" 5 "Certificate" 6 "Unspecified" 7 "Master's" 8 "Doctoral" 9 "Postdoctorate" 10 "First professional" 11 "Unspecified graduate"
	...
	* COLLEGE SEQUENCE
	...
	la var CollegeSequence "Sequence of college attandence"
	...
	*****HS grad year not populated in newest NSC file
	/*gen gradyearnsc=substr(highschoolgraddate, 1, 4)
	destring gradyearnsc, replace
	la var gradyearnsc "HS Gradyear"
	*/
	...
	*KEEPING THIS YEAR TO SEE WHAT IDs ARE/ARE NOT IN THE NSC PULL 
	* DROP IF NO RECORD IS FOUND
